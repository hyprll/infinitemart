            ...
            <div class="flexWrapper">
                <div class="WrapperOwl d-flex owl-carousel owl-theme">
                    <div class="col-md-4">
                        <div class="cardOurTeam">
                            ...
                            <div class="contentOurTeam mt-2">
                                ...
                                <p class="text-center" style="margin-bottom: 60px;">Membuat 60% Front End HTML dan CSS di halaman user, membuat register, 
                                    membuat 100% Front End HTML dan CSS di halaman Admin, membuat 85% Front End Javascript di halaman Admin</p>
                                <div class="d-flex align-items-end justify-content-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
                    ...
                    <div class="col-md-4">
                        <div class="cardOurTeam">
                            ...
                            <div class="contentOurTeam mt-2">
                                ...
                                <p class="text-center" style="margin-bottom: 60px;">Planning, analisis masalah, Desainer User, Login, Register</p>
                                <div class="d-flex align-items-end justify-content-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
                    ...
                    <div class="col-md-4">
                        <div class="cardOurTeam">
                            <div class="ImgOurTeam d-flex justify-content-center">
                                <img class="rounded-circle" src="{{asset('img')}}/Profile_AboutUs/Rizky.jpg" alt="">
                            </div>
                            <div class="contentOurTeam mt-2">
                                <h5 class="text-center">Rizki Ramadhan</h5>
                                <p class="text-center">As a front end Dev</p>
                                <p class="text-center" style="margin-bottom: 60px;">Membuat 100% Front End Javascript di halaman user, Membuat Seller Account, Membuat 15% Front End Javascript di halaman admin, Membuat Halaman Searching Produk dan Edit Produk</p>
                                <div class="d-flex align-items-end justify-content-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
                    ...
                    <div class="col-md-4">
                        <div class="cardOurTeam">
                            ...
                            <div class="contentOurTeam mt-2">
                                ...
                                <p class="text-center">As a front end Dev</p>
                                <p class="text-center" style="margin-bottom: 60px;">Membuat halaman login dan halaman profile user</p>
                                <div class="d-flex align-items-end justify-content-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
                    ...
                    <div class="col-md-4">
                        <div class="cardOurTeam">
                            ...
                            <div class="contentOurTeam mt-2">
                                ...
                                <p class="text-center">As a front end Dev</p>
                                <p class="text-center" style="margin-bottom: 60px;">Membuat halaman welcome dan halaman history user</p>
                                <div class="d-flex align-items-end justify-content-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
                    ...
                    <div class="col-md-4">
                        <div class="cardOurTeam">
                            ...
                            <div class="contentOurTeam mt-2">
                                ...
                                <p class="text-center">As a UI/UX design</p>
                                <p class="text-center" style="margin-bottom: 60px;">Membuat Banner, Gambar Produk dan Logo InfiniteMart</p>
                                <div class="d-flex align-items-end justify-content-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
                    ...
                    <div class="col-md-4">
                        <div class="cardOurTeam">
                            ...
                            <div class="contentOurTeam mt-2">
                                ...
                                <p class="text-center">As a UI/UX design</p>
                                <p class="text-center" style="margin-bottom: 60px;">Membuat Mockup admin, maskot dan banner</p>
                                <div class="d-flex align-items-end justify-content-center position-absolute" style="bottom: 20px; left: 50%; transform: translateX(-50%);">
