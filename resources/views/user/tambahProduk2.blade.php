...
<div id="addProdukSectionReadOnly"></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input mt-1" type="radio" id="all" checked
                                        name="user_permitted" value="1">
                                    <label class="form-check-label mt-0" for="all">
                                        Semua User
                                    </label>
                                </div>
                            </div>
